    ...
    async function fetchData() {
      ...
      try {
        ...
        setErrorFetchingData({
          message: error.message || "Failed to fetching user places.",
        });
      }
  ...
  async function handleSelectPlace(selectedPlace) {
    ...
    try {
      ...
      setErrorUpdatingUserPlaces({
        message: error.message || "Failed to updating user places",
      });
    }
  }
    ...
    <>
      ...
      <main>
        {errorFetchingData && (
          <ErrorPage
            title={"An error occurred :("}
            message={errorFetchingData.message}
          />
        )}
        {!errorFetchingData && (
          <Places
            ...
            isLoadingText={"Fetching places selected by user..."}
            places={userPlaces}
